...
public class SolublePowder extends AbstractMedicalProduct {
  ...
  public SolublePowder(int massinGrams, int shelfLifeInMonths,
            ...
            Toxicity toxicityCategory, String solubility) {
    super(massinGrams, shelfLifeInMonths, priceInUAH,
                nameOfProduct, producingCountry, compositionOfProduct,sideEffects,
                needOfDoctorsPrescription, applicationMethod, theraupeticEffect, toxicityCategory);
    this.solubility = solubility;
  }
	private String solubility;
