...
public class Syringe extends AbstractEveryDayProduct {
  ...
  public Syringe(int massinGrams, int shelfLifeInMonths,
      double priceInUAH, String nameOfProduct,
      String producingCountry, String compositionOfProduct, String sideEffects,
      int quantityInOnePackage,int capacityInMl, int lengthOfNeedleInCm) {
    super(massinGrams, shelfLifeInMonths, priceInUAH, nameOfProduct, 
          producingCountry, compositionOfProduct,sideEffects, quantityInOnePackage);
    this.capacityInMl = capacityInMl;
    this.lengthOfNeedleInCm = lengthOfNeedleInCm;
  }
